...
var _ jsonschema.InterceptTypeFunc = InterceptType

// InterceptType is a jsonschema.InterceptTypeFunc to process swgen types.
func InterceptType(v reflect.Value, s *jsonschema.Schema) (bool, error) {
	i := v.Interface()
...
// LoadFromSwgen populates JSON Schema from Swagger Data.
